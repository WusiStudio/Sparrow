...
namespace ROOT_NAMESPACE
{
    ...
    {
        unsigned result = 0;
        eachString( p_str, [&result](const unsigned int p_index, const unsigned int p_size, const unsigned int p_realLength)->bool{
            result += p_realLength;
            return true;
        }, p_coding );
        return result;
    ...
    inline std::vector<std::string> split( const std::string & p_str, const std::string & p_clapboard )
    {
